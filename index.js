...
5. Дополнительный не предусмотренный в задании функционал +10 
   - к сожалению не успела :( Извините
   ° может, эффекты при наведении на фото считаются?
   ° header при прокрутке страницы остается на месте
   ° есть немного адаптива 
